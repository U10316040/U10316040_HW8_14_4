	...
	public static void main(String[] args) {
	 ...
	 class Loan {
		  ...
		  public Loan(double annualInterestRate, int numberOfYears,double loanAmount)throws IllegalArgumentException {
			  ...
			  if(annualInterestRate<=0 || numberOfYears<=0 || loanAmount<=0){//Judge the annual interest rate,number of years,loan amount whether less than or equal to zero,if it is true,throw the IllegalArgumentException
